...
`,Cs=({onClick:e,className:t,hasConditions:o=!1,variant:n="tertiary"})=>{const{formatMessage:r}=(0,I.A)();return(0,s.jsx)(xs,{hasConditions:o,className:t,children:(0,s.jsx)(B.$,{variant:n,startIcon:(0,s.jsx)(Ze.A,{}),onClick:e,children:r({id:"global.settings",defaultMessage:"Settings"})})})},xs=(0,S.default)(O.a)`
  ...
  `}
`,ae=(0,S.default)(Cs)``,Be=({actions:e=[],headerBreadCrumbs:t=[],isFormDisabled:o,onClosed:n,onToggle:r})=>{const{formatMessage:a}=(0,I.A)(),{availableConditions:d,modifiedData:i,onChangeConditions:l}=X(),c=y.useMemo(()=>Object.entries(ue(d,"category")),[d]),u=e.filter(({isDisplayed:h,hasSomeActionsSelected:f,hasAllActionsSelected:j})=>h&&Boolean(f||j)),[g,m]=y.useState(_s(u,i,c)),C=(h,f)=>{m((0,ye.Ay)(j=>{j[h]||(j[h]={}),j[h].default||(j[h].default={}),j[h].default=f}))},x=()=>{const h=Object.entries(g).reduce((f,j)=>{const[P,$]=j,E=Object.values($).reduce((b,v)=>({...b,...v}),{});return f[P]=E,f},{});l(h),r()};return(0,s.jsxs)(K.k,{labelledBy:"condition-modal-breadcrumbs",onClose:n,children:[(0,s.jsx)(Q.r,{children:(0,s.jsx)(es.B,{id:"condition-modal-breadcrumbs",label:t.join(", "),children:t.map((h,f,j)=>(0,s.jsx)(ss.m,{isCurrent:f===j.length-1,children:ts(a({id:h,defaultMessage:h}))},h))})}),(0,s.jsxs)(le.c,{children:[u.length===0&&(0,s.jsx)(A.o,{children:a({id:"Settings.permissions.conditions.no-actions",defaultMessage:"You first need to select actions (create, read, update, ...) before defining conditions on them."})}),(0,s.jsx)("ul",{children:u.map(({actionId:h,label:f,pathToConditionsObject:j},P)=>{const $=j.join("..");return(0,s.jsx)(ys,{arrayOfOptionsGroupedByCategory:c,label:f,isFormDisabled:o,isGrey:P%2===0,name:$,onChange:C,value:M(g,$,{})},h)})})]}),(0,s.jsx)(de.j,{startActions:(0,s.jsx)(B.$,{variant:"tertiary",onClick:r,children:a({id:"app.components.Button.cancel",defaultMessage:"Cancel"})}),endActions:(0,s.jsx)(B.$,{onClick:x,children:a({id:"Settings.permissions.conditions.apply",defaultMessage:"Apply"})})})]})},_s=(e,t,o)=>e.reduce((n,r)=>{const a=M(t,[...r.pathToConditionsObject,"conditions"],{}),d=o.reduce((i,l)=>{const[c,u]=l,g=u.reduce((m,C)=>(m[C.id]=M(a,C.id,!1),m),{});return i[c]=g,i},{});return n[r.pathToConditionsObject.join("..")]=d,n},{}),ys=({arrayOfOptionsGroupedByCategory:e,isFormDisabled:t=!1,isGrey:o=!1,label:n,name:r,onChange:a,value:d})=>{const{formatMessage:i}=(0,I.A)(),l=c=>{a&&a(r,Es(e,c))};return(0,s.jsxs)(_.s,{as:"li",background:o?"neutral100":"neutral0",paddingBottom:3,paddingTop:3,children:[(0,s.jsxs)(_.s,{paddingLeft:6,style:{width:180},children:[(0,s.jsxs)(A.o,{variant:"sigma",textColor:"neutral600",children:[i({id:"Settings.permissions.conditions.can",defaultMessage:"Can"}),"\xA0"]}),(0,s.jsx)(A.o,{variant:"sigma",title:n,textColor:"primary600",ellipsis:!0,children:i({id:`Settings.roles.form.permissions.${n.toLowerCase()}`,defaultMessage:n})}),(0,s.jsxs)(A.o,{variant:"sigma",textColor:"neutral600",children:["\xA0",i({id:"Settings.permissions.conditions.when",defaultMessage:"When"})]})]}),(0,s.jsx)(O.a,{style:{maxWidth:430,width:"100%"},children:(0,s.jsx)(Ne.B,{id:r,customizeContent:(c=[])=>`${c.length} currently selected`,onChange:l,value:js(d),options:Os(e),disabled:t})})]})},js=e=>Object.values(e).map(t=>Object.entries(t).filter(([,o])=>o).map(([o])=>o)).flat(),Os=e=>e.reduce((t,[o,n])=>(t.push({label:re(o),children:n.map(r=>({label:r.displayName,value:r.id}))}),t),[]),Es=(e,t)=>e.map(([,o])=>o).flat().reduce((o,n)=>({[n.id]:t.includes(n.id),...o}),{}),bs=({actions:e=[],isFormDisabled:t,pathToData:o,subjects:n=[]})=>{const[r,a]=y.useState(null),d=i=>()=>{a(r===i?null:i)};return(0,s.jsx)(s.Fragment,{children:n.map(({uid:i,label:l,properties:c},u)=>{const g=r===i,m=e.map(C=>({...C,isDisplayed:Array.isArray(C.subjects)&&C.subjects.indexOf(i)!==-1}));return(0,s.jsxs)(_.s,{direction:"column",display:"inline-flex",minWidth:"100%",borderColor:"primary600",borderWidth:g?1:0,children:[(0,s.jsx)(As,{availableActions:m,isActive:g,isGrey:u%2===0,isFormDisabled:t,label:l,onClickToggle:d(i),pathToData:[o,i].join("..")}),g&&c.map(({label:C,value:x,children:h})=>(0,s.jsx)(as,{availableActions:m,childrenForm:h,isFormDisabled:t,label:C,pathToData:[o,i].join(".."),propertyName:x},x))]},i)})})},As=({availableActions:e=[],isActive:t=!1,isGrey:o=!1,isFormDisabled:n=!1,label:r,onClickToggle:a,pathToData:d})=>{const[i,l]=y.useState(!1),{formatMessage:c}=(0,I.A)(),{modifiedData:u,onChangeParentCheckbox:g,onChangeSimpleCheckbox:m}=X(),C=()=>{l(b=>!b)},x=()=>{l(!1)},h=M(u,d.split(".."),{}),f=y.useMemo(()=>Object.keys(h).reduce((b,v)=>(b[v]=je(h[v],"conditions"),b),{}),[h]),{hasAllActionsSelected:j,hasSomeActionsSelected:P}=G(f),$=y.useMemo(()=>Ms(e,u,d),[e,u,d]),E=$.some(b=>b.hasConditions);return(0,s.jsxs)(Ps,{isActive:t,children:[(0,s.jsxs)(Ie,{height:ie,flex:1,alignItems:"center",background:o?"neutral100":"neutral0",children:[(0,s.jsx)(Le,{isCollapsable:!0,isFormDisabled:n,label:r,checkboxName:d,onChange:g,onClick:a,someChecked:P,value:j,isActive:t,children:(0,s.jsx)(We,{paddingLeft:2,children:t?(0,s.jsx)(ze.A,{}):(0,s.jsx)(qe.A,{})})}),(0,s.jsx)(_.s,{style:{flex:1},children:$.map(({actionId:b,hasSomeActionsSelected:v,isDisplayed:T,...R})=>{if(!T)return(0,s.jsx)(me,{},b);const{hasConditions:k,hasAllActionsSelected:L,isParentCheckbox:Y,checkboxName:H,label:te}=R;return Y?(0,s.jsxs)(ke,{justifyContent:"center",alignItems:"center",children:[k&&(0,s.jsx)(O.a,{as:"span",position:"absolute",top:"-6px",left:"37px",width:"6px",height:"6px",borderRadius:"20px",background:"primary600"}),(0,s.jsx)(D.J,{disabled:n,name:H,"aria-label":c({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${te} ${r}`}),onValueChange:W=>{g({target:{name:H,value:W}})},indeterminate:v,value:L})]},b):(0,s.jsxs)(ke,{justifyContent:"center",alignItems:"center",children:[k&&(0,s.jsx)(O.a,{as:"span",position:"absolute",top:"-6px",left:"37px",width:"6px",height:"6px",borderRadius:"20px",background:"primary600"}),(0,s.jsx)(D.J,{disabled:n,indeterminate:k,name:H,onValueChange:W=>{m({target:{name:H,value:W}})},value:L})]},b)})}),i&&(0,s.jsx)(Be,{headerBreadCrumbs:[r,"Settings.permissions.conditions.conditions"],actions:$,isFormDisabled:n,onClosed:x,onToggle:C})]}),(0,s.jsx)(O.a,{transform:"translateY(10px)",right:"9px",position:"absolute",children:(0,s.jsx)(ae,{onClick:C,hasConditions:E})})]})},Ms=(e,t,o)=>e.map(({actionId:n,isDisplayed:r,applyToProperties:a,label:d})=>{if(!r)return{actionId:n,hasSomeActionsSelected:!1,isDisplayed:r};const i=[...o.split(".."),n],l=z(a)?[...i,"properties","enabled"]:i,c=M(t,[...i,"conditions"],null),u={actionId:n,checkboxName:l.join(".."),hasConditions:F(c).some(x=>x),isDisplayed:r,label:d,pathToConditionsObject:i};if(z(a)){const x=M(t,l,!1);return{...u,hasAllActionsSelected:x,hasSomeActionsSelected:x,isParentCheckbox:!1}}const g=M(t,l,null),{hasAllActionsSelected:m,hasSomeActionsSelected:C}=G(g);return{...u,hasAllActionsSelected:m,hasSomeActionsSelected:C,isParentCheckbox:!0}}),fe=(e,t)=>`
  ${Ie} {

    ...
    return (
        <div className="relative w-full md:w-full max-w-full mx-auto dark:pt-0">
            ...
            <div className='md:absolute md:mt-[0rem] mt-4 relative px-4 sm:px-0 left-0 right-0 md:top-0 top-4 bottom-0 w-full max-w-[1280px] mx-auto'>
                <div className="px-8 py-8 sm:px-16 sm:py-16 bg-[#16a34a] md:absolute bottom-0 right-0 md:rounded-tl-[30px] sm:rounded-tl-[60px] sm:rounded-tr-none sm:rounded-b-none w-full sm:w-[38.375rem] h-auto rounded-[37px] flex flex-col justify-center">

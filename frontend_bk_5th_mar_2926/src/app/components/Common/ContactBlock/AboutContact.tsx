        ...
        <>
            ...
            ></div>
                ...
                <div className='md:absolute left-0 right-0 top-0 bottom-0 w-full max-w-[1280px] mx-auto'>
                    <div className="px-4 py-4 sm:px-8 sm:py-8 bg-[#16a34a] absolute top-[50%] translate-y-[-50%] z-20 right-0 rounded-3xl w-full sm:w-[28rem] flex justify-center items-center flex-col md:left-auto mx-auto left-0 max-w-[90%] md:max-w-fit opacity-90">
